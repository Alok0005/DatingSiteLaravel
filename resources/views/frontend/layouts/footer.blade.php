  ...
  <!-- Start Footer Area -->
    ...
    <div class="copy-right-area" style="padding: 10px 0px; background: #1754b8;">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
	<div class="row justify-content-center" style="color:#FFF;">
			A Division of SBCA Inc. |&nbsp <a href="index.html" style="color:#FFF;"> Dating &nbsp;</a>@ 2022 All Rights Reserved
		</div>
						</div>
