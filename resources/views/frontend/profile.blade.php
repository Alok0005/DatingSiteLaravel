                                   ...
                                   {!! csrf_field() !!}
								    @if(!empty($data->profile_img ?? ''))
                                      <img src="{{'storage/profile/'.$data->profile_img.''}}" alt="DP">
                                       @else
										   <img src="{{'frontend/images/profile/'.Auth::user()->image.''}}" alt="DP">
								  @endif
                  ...
                  <div class="info-card mb-20">
                      ...
                      <div class="info-card-content" id="hide-div">
                          <ul class="info-list">
                              <li>
                                  <p class="info-name">Name</p>
                                 <input type="text" name="name" value="{{ $data->name ?? Auth::user()->name}}" class="form-new">
                              </li>
                              <li>
                                  <p class="info-name">I'm a</p>
                                  <select class="form-select new" name="gender">
								  <option value="{{$data->gender ?? Auth::user()->gender}}" >{{$data->gender ?? Auth::user()->gender}}</option>
                              ...
                              <li>
								  ...
								  <option value="{{$data->looking_for ?? ''}}" >{{$data->looking_for ?? Auth::user()->looking_for}}</option>
                                    <option value="Woman">Woman</option>
                                     <option value="Man">Man</option>
